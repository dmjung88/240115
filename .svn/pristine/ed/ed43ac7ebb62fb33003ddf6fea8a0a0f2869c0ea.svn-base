  ...
  <div class="frame-container">
    <div class="frame-frame">
      ...
      <form id="wholeSaveForm" autocomplete="off">
        ...
        <input type="text" id="zipCode" name="zipCode" placeholder="우편번호를 입력해 주세요." class="frame-rectangle31" readonly="readonly" />
        ...
        <div class="frame-frame14">
            ...
            <span class="frame-text52"><span><a href="{{ route('master.wholeAdd')}}">도매장</a></span></span>
            </div>
            <div class="frame-frame2">
            <span class="frame-text54"><span><a href="{{ route('master.storeAdd')}}">업소</a></span></span>
            </div>
            <div class="frame-frame3">
            <span class="frame-text56"><span><a href="{{ route('master.goodsAdd')}}">상품</a></span></span>
            </div>
            <div class="frame-frame4">
            <span class="frame-text58"><span><a href="{{ route('master.fixAdd')}}">수리업무</a></span></span>
            </div>
            <div class="frame-frame5">
            <span class="frame-text60"><span><a href="{{ route('master.empAdd')}}">영업사원</a></span></span>
            </div>
        </div>
        <div class="frame-frame32">
            <div class="frame-gnb">
            <span class="frame-text62"><span><a href="">마스터</a></span></span>
            </div>
            <div class="frame-gnb1">
            <span class="frame-text64"><span><a href="">업무</a></span></span>
            </div>
            <div class="frame-gnb2">
            <span class="frame-text66"><span><a href="">발행</a></span></span>
            </div>
            <div class="frame-gnb3">
            <span class="frame-text68"><span><a href="">채권</a></span></span>
            </div>
            <div class="frame-gnb4">
            <span class="frame-text70"><span><a href="">세금계산서</a></span></span>
            </div>
        </div>
